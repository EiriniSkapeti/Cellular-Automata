...
def update_grid(grid, width, height):
    ...
    for y in range(height-1):
        for x in range (1, width-1):
            ...
            elif grid[y][x] == 1 and grid[y][x-1]== 0 and grid[y][x+1]== 1: new_grid[y+1][x]= 0
            elif grid[y][x] == 0 and grid[y][x-1]== 1 and grid[y][x+1]== 0: new_grid[y+1][x]= 1
            elif grid[y][x] == 0 and grid[y][x-1]== 1 and grid[y][x+1]== 1: new_grid[y+1][x]= 0
            elif grid[y][x] == 1 and grid[y][x-1]== 1 and grid[y][x+1]== 0: new_grid[y+1][x]= 0
            elif grid[y][x] == 1 and grid[y][x-1]== 1 and grid[y][x+1]== 1: new_grid[y+1][x]= 1
